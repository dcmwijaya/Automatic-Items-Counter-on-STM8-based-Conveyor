...
Sistem penghitung barang otomatis adalah suatu mekanisme yang mampu bekerja dengan sendirinya untuk menyelesaikan berbagai masalah yang ada hubungannya dengan kalkulasi barang. Tujuan diadakannya proyek ini adalah untuk memberikan edukasi kepada masyarakat luas tentang bagaimana cara membuat alat penghitung barang otomatis yang sederhana. Proyek ini telah dilaksanakan dan memakan waktu kurang lebih 2 minggu. Sistem ini dibuat untuk digunakan sebagai pelengkap pada konveyor. Selain itu, sistem ini juga dilengkapi dengan fitur display dan reset. Cara kerja dari sistem penghitung barang otomatis ini yaitu apabila barang melewati sinar laser, dalam hal ini menghalangi cahaya yang masuk pada sensor LDR, maka barang akan terdeteksi. Adapun hasil penghitungannya akan ditampilkan pada layar LCD. Proyek ini akan berguna bagi para pelaku bisnis, karena dapat meningkatkan efisiensi dalam produksi. Hasil penelitian menunjukkan bahwa sistem yang dibuat ini dapat berfungsi dengan baik.
